...
import { nextPage, backPage } from "./Reducer";
      ...
      case 1:
        return (
          <div className="App">
            ...
            <button className="OnLight" onClick={() => dispatch(nextPage())}>
              Next
            </button>
          </div>
        );
      case 2:
        return (
          <div className="App">
            ...
            <button className="OnBack" onClick={() => dispatch(backPage())}>
              Back
            </button>
          </div>
        );
      ...
      case 4:
        return (
          <div className="App">
            ...
            <br />
            <br />
            <button className="OnSubmit" onClick={() => submitStepHander()}>
              submit
            </button>
            <button className="OnBack" onClick={() => dispatch(backPage())}>
              Back
